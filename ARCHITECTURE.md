...
9. **Registration**: Dual-mode registration system. Handles **Local Profile** (internal state) and **Official Government Yatra Registration** (via secure WebView dashboard and official WhatsApp integration).
```
