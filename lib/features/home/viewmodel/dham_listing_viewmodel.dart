...
class DhamListingState {
  ...
  DhamListingState({
    ...
    this.yatraUpdate = 'Yatra Update: All 4 Dhams are open for Darshan. Stay Updated for weather and Route conditions.',
  });
    ...
    state.whenData((data) {
      ...
      switch (filter) {
        ...
        case DhamFilter.lowCrowd:
          filtered = data.allDhams.where((d) => d.crowdStatus == 'Low').toList();
          break;
